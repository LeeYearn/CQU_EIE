...
void tip(int count)
{
    ...
    case 12:
        ...
        break;
    case 13:
        cout << "\033[1;33m请输入障碍物状态\n[1]前方障碍\n[2]左前方障碍\n[3]右前方障碍\n[4]关闭小车\033[0m" << endl;
        break;
    }
}

int createNewInfo(vector<SmartCar> &carList, vector<Student> &stuList, int a)
{
    tip(5);
    string input;
    cin >> input;
...
void init(vector<SmartCar> &carList, vector<Student> &stuList, int a, string input)
{
    if (a)
    {
        tip(8);
