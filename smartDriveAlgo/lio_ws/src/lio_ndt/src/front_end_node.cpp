...
int main(int argc, char *argv[])
{
    ...
    if ( gnss_output_file == "" ) {
        ...
        gnss_output_file = "/home/liy/lio_ws/src/lio_ndt/data/gnss.csv";
        odom_output_file = "/home/liy/lio_ws/src/lio_ndt/data/odom.csv";
      }
    ...
    std::shared_ptr<OdomBagSubscriber>  odom_bag_sub_ptr = std::make_shared<OdomBagSubscriber>(nh, "/laser_odom", 100000, "/home/liy/lio_ws/src/lio_ndt/data/odom.bag", "/odom");
    std::shared_ptr<OdomBagSubscriber>  gt_bag_sub_ptr   = std::make_shared<OdomBagSubscriber>(nh, "/gnss",       100000, "/home/liy/lio_ws/src/lio_ndt/data/gnss.bag", "/gt_odom");
